      ...
      <section className="container">
        ...
        <div className="row marketing">
          ...
          <Difference title="Customer-Centric">
            ...
            through the listing of the various sellers and places an order. But
            on Flipin its opposite sellers look through the listing
          </Difference>
          ...
          <Difference title="Ease in communication">
            With our chat feature, the communication can be done in an effective manner and many misconceptions can be avoided with the help of the same 
          </Difference>
        </div>
      </section>
    );
